...
## Notities
- Werkplaats-meetrapport (sessie 8, /projecten/): de cijfers op het case-bonnetje zijn gemeten op 09-07-2026 en moeten **elk kwartaal herijkt** worden (volgende: oktober 2026). Verouderde metingen zijn erger dan geen metingen. Methode per cijfer staat in de voetnoten op de pagina; reproductie: Lighthouse 13.4 ×5 (mediaan, mobiel), transferSize-som homepage ×3, layout-shift-observer met 500ms font-delay, git log.
